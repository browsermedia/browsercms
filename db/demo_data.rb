...
create_page(:support, :name => "Support", :path => "/support", :section => sections(:support), :template => "Sub Page")
create_page(:forums, :name => "Forums", :path => "/support/forums", :section => sections(:support), :template => "Sub Page")
create_page(:docs, :name => "Documentation", :path => "/documentation", :section => sections(:docs), :template => "Sub Page")
create_page(:api, :name => "API", :path => "/documentation/api", :section => sections(:docs), :template => "Sub Page")
create_page(:downloads, :name => "Downloads", :path => "/downloads", :section => sections(:downloads), :template => "Sub Page")
create_page(:gems, :name => "Building a Gem", :path => "/downloads/gems", :section => sections(:downloads), :template => "Sub Page")
create_page(:contribute, :name => "Contribute", :path => "/contribute", :section => sections(:contribute), :template => "Sub Page")
create_page(:github, :name => "Using Github", :path => "/contribute/github", :section => sections(:contribute), :template => "Sub Page")
...
create_page(:demo, :name => "Demo", :path => "/util_nav/demo", :section => sections(:util), :template => "Sub Page")
create_page(:contact_us, :name => "Contact Us", :path => "/util_nav/contact_us", :section => sections(:util), :template => "Sub Page")
create_page(:about, :name => "About Us", :path => "/util_nav/about_us", :section => sections(:util), :template => "Sub Page")

# Footer Nav
create_section(:footer, :name => "Footer Nav", :parent => root_section, :path => "/footer_nav", :hidden => true)
create_page(:demo, :name => "Site Map", :path => "/footer_nav/site_map", :section => sections(:footer), :template => "Sub Page")
create_page(:contribute, :name => "Privacy Policy", :path => "/footer_nav/privacy_policy", :section => sections(:footer), :template => "Sub Page")
create_link(:contact_us, :name => "Contact Us", :url => "/footer_nav/contact_us", :section => sections(:footer))
create_page(:our_office, :name => "Our Office", :path => "/footer_nav/our_office", :section => sections(:footer), :template => "Sub Page")
