...
class NewFileTest < ActiveSupport::TestCase
  ...
  #test "#valid? requires attachment_file_path" do
  #  @file.file = mock_file
  #  assert !@file.valid?
...
#     @section = create(:section, :parent => root_section, :name => "New")
...
#     @file_block = create(:file_block, :attachment_file => @file1, :attachment_file_path => "/test.txt", :attachment_section => root_section)
...
#   def setup
#     @one = create(:file_block, :attachment_file => mock_file, :attachment_file_path => "/one.txt", :attachment_section => root_section)
#     @two = create(:file_block, :attachment_file => mock_file, :attachment_file_path => "/two.txt", :attachment_section => root_section)
#     @section = create(:section, :name => "A")
#     @a1 = create(:file_block, :attachment_file => mock_file, :attachment_file_path => "/a/1.txt", :attachment_section => @section)
#     @a2 = create(:file_block, :attachment_file => mock_file, :attachment_file_path => "/2.txt", :attachment_section => @section)
#     #reset(:one, :two, :a1, :a2)
#   end
