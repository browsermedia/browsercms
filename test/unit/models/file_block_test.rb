...
module Cms
  class FileBlockTest < ActiveSupport::TestCase
    ...
    def setup
      ...
      @file_block = Factory.build(:file_block, :attachment_file => @uploaded_file, :attachment_section => @root, :attachment_file_path => "/test.jpg", :publish_on_save => true)
    end
  ...
  class ExistingFileBlocksTest < ActiveSupport::TestCase
    ...
    test "search by section" do
      ...
      options[:conditions] = ["cms_section_nodes.ancestry = ?", root_section.ancestry_path]
