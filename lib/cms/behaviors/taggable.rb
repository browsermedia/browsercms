    ...
    module Taggable
      ...
      module MacroMethods      
        ...
        def is_taggable(options={})
          ...
          has_many :tags, :through => :taggings, :order => "#{Tag.table_name}.name", :class_name => 'Cms::Tag'          
          
          named_scope :tagged_with, lambda{|t| {:include => {:taggings => :tag}, :conditions => ["#{Tag.table_name}.name = ?", t]} }          
